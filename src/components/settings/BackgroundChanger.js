            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative flex-auto w-100">
                  <div className="w-100 flex items-center justify-between p-3 cursor-pointer default-hover-2" onClick={openColorSelection}>
                  ...
                  <div className="flex items-center p-3 mb-3 justify-between cursor-pointer default-hover-2" onClick={openFileSelection}>
